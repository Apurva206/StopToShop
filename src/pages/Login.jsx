    ...
    <>
     <div className="flex justify-center w-[100%] h-[100vh] bg-Green">
      ...
      <form className='container' onSubmit={handleSubmit}>
        ...
        <div className='text-center pt-[10px]'>
          <button type='submit'className='rounded-[6px] border-black bg-Green py-2 px-4 text-black hover:text-grey mt-[6px] hover:bg-white hover:text-[#8a4af3] hover:scale-[1.0.5] border-[2px] hover:shadow-md hover:border-[#8a4af3]'>Submit</button>
        </div>
      </form>
      </div>
      </div>
